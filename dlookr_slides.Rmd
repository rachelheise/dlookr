...
- `diagnose_category` is used to assess categorical variables by:

  - Identifying the levels of each categorical variable
  - Noting the number & percentage of observations at each level
  - Ranking each level in terms of number of observations
